...
*************************************************************************************************************
	...
	If score is within 0.5 points of the next whole point, it rounds up and recalculates the letter grade.  *
*************************************************************************************************************
*/
...
void FinalExam::adjustScore(){
	...
	if (fraction >= 0.5){
		//Adjust the score variable in the GradeActivity class.
		score += (1.0 - fraction);
	}
}